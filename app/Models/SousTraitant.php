...
class SousTraitant extends Model
{
    ...
    {
        return $this->hasMany(Vaccination::class, 'sousTraitant_id');
    }

        //the latest consultation of the sousTraitant
        public function latest_consultation()
        {
            return $this->hasOne(Consultation::class, 'sousTraitant_id')->latestOfMany();
        }
